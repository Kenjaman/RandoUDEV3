...
<a href="<c:url value='/stop'/>"
	class="h1 text-success text-align-center">Association de randonnée
	K.P</a>
<nav class="navbar navbar-navbar navbar-expand-lg navbar-dark bg-dark pt-5 pb-3">
	...
	<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		<div class="nav navbar-nav">
			<a class="nav-link" href="<c:url value='/itineraires'/>"> Liste
				des itinéraires&nbsp;<span class="badge badge-light"><c:out
						value="${sessionScope.nbItineraires}" /></span>
			</a> <a class="nav-link" href="<c:url value='/etapes'/>"> Liste des
				étapes&nbsp;<span class="badge badge-light"><c:out
						value="${sessionScope.nbEtapes}" /></span>
			</a>
  ...
  <path fill-rule="evenodd"
			...
			<c:if test="${!empty sessionScope.moi}">
				...
				<a class="nav-link" href="#"> <span class="badge badge-success">Bienvenue
						<c:out value="${sessionScope.moi}" />
				</span>
				</a>
			</c:if>
		</div>
